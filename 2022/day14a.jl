function main()
    ...
    min_x = 501 # Account for sand starting point (1-indexed) in mins and maxes
    max_x = 501
    ...
    grid = zeros(Bool, max_x - min_x + 1, max_y - min_y + 1)
